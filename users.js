...
exports.verify_later = exports.verify_email = exports.user_refresh = exports.request_otp = exports.register_user = exports.login = void 0;
...
var request_otp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, res) {
    var code;
...
var verify_email = /*#__PURE__*/function () {
  ...
  return function verify_email(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
exports.verify_email = verify_email;
var verify_later = function verify_later(req, res) {
...
exports.verify_later = verify_later;
var user_refresh = function user_refresh(req, res) {
  var user = req.params.user;
  res.json({
    ok: true,
    message: 'user refreshed',
    data: _conn.USERS.readone(user)
  });
};
...
var register_user = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var user, password, email_used, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          email_used = _conn.USERS.readone({
            email: user.email
          });
        ...
        case 6:
          if (email_used) result = email_used;else {
            result = _conn.USERS.write(user);
  ...
  return function register_user(_x5, _x6) {
...
var login = function login(req, res) {
  ...
  var hash = _conn.USERS_HASH.readone({
    user: user._id,
    password: password
  });
